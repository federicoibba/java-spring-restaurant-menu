...
public interface PlateControllerDocs {
  ...
  @ApiResponse(
    ...
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = PlateDto.class))
  )
  @ApiResponse(
    responseCode = "404",
    description = "Plate not found",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class, example = "{ \"code\": \"NOT_FOUND\", \"message\": \"Plate not found\" }"))
  )
  ...
  @ApiResponse(
    responseCode = "200",
    description = "Plates found",
    content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = PlateDto.class)))
  )
  ...
  @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Plate to create", required = true,
    content = @Content(mediaType = "application/json",
      ...
      examples = @ExampleObject(value = "{ \"name\": \"Onion soup\" }")))
  ...
  @ApiResponse(
    responseCode = "404",
    description = "Plate not found",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class, example = "{ \"code\": \"NOT_FOUND\", \"message\": \"Cannot delete a plate that does not exist\" }"))
  )
  ...
  @ApiResponse(
    responseCode = "400",
    description = "Bad request - Ingredient does not exist",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class, example = "{ \"code\": \"NOT_FOUND\", \"message\": \"Cannot add an ingredient that does not exist\" }"))
  )
  @ApiResponse(
    responseCode = "404",
    description = "Not found - Plate does not exist",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class, example = "{ \"code\": \"NOT_FOUND\", \"message\": \"Cannot add an ingredient to a plate that does not exist\" }"))
  )
  ResponseEntity<PlateDto> addIngredient(@PathVariable("id") String plateId,
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Ingrediet to add to the plate", required = true,
      content = @Content(mediaType = "application/json",
        schema = @Schema(implementation = PlateDto.class),
        examples = @ExampleObject(value = "{ \"id\": \"Ingredient ID\" }")))
  ...
  @ApiResponse(
    responseCode = "400",
    description = "Bad request - Ingredient was never in the plate",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class, example = "{ \"code\": \"NOT_FOUND\", \"message\": \"Cannot delete an ingredient from the plate because it was never one of its ingredients\" }"))
  )
  @ApiResponse(
    responseCode = "404",
    description = "Not found - Plate does not exist / Ingredient does not exist",
    content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorDto.class, example = "{ \"code\": \"NOT_FOUND\", \"message\": \"Cannot remove an ingredient that does not exist from a plate\" }"))
  )
